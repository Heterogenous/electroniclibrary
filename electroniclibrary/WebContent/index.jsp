...
<ul class="layui-nav layui-bg-green">
	...
	<li class="layui-nav-item"><a href="index-jsj.jsp">计算机</a></li>
...
<!--中部内容-->
<div class="center">
	<div class="pictureShow-top">
		<div class="layui-carousel" id="test1">
		  <div carousel-item>
			<div><img src="runImg/10.jpg"/></div>
			<div><img src="runImg/10.jpg"/></div>
			<div><img src="runImg/10.jpg"/></div>
			<div><img src="runImg/10.jpg"/></div>
			<div><img src="runImg/10.jpg"/></div>
	...
	<div class="contentShow-bottom">
		<div class="newBook-left">
		<div class="newBook-left-title"><a href="index-all.jsp">查看全部<i class="layui-icon layui-icon-next"></i></a></div>
		<div class="newBook-left-hr"><hr class="layui-bg-blue"></div>
			<div class="newBook-left-row">
				<c:forEach var="book" items="${booklist}" varStatus="varState" end="3">
					<c:if test="${varState.count==1}">
					...
					<c:if test="${varState.count!=1}">
					<div class="bookShow" style="margin-left:18px">
					<div class="picture"><a href="${pageContext.request.contextPath}/FindBookDetailServlet?bid=${book.bid}" target="_blank"><img src="bookUrl/${book.imgUrl}" width="200" height="284" /></a></div>
					<div class="bookName"><a href="${pageContext.request.contextPath}/FindBookDetailServlet?bid=${book.bid}" target="_blank">${book.bookName}</a></div>
					</div>
					</c:if>
			...
			<div class="newBook-left-row">
				<c:forEach var="book" items="${booklist}" varStatus="varState" begin="4" end="7">
					<c:if test="${varState.count==1}">
					<div class="bookShow" style="margin-right:18px">
					<div class="picture"><a href="${pageContext.request.contextPath}/FindBookDetailServlet?bid=${book.bid}" target="_blank"><img src="bookUrl/${book.imgUrl}" width="200" height="284" /></a></div>
					<div class="bookName"><a href="${pageContext.request.contextPath}/FindBookDetailServlet?bid=${book.bid}" target="_blank">${book.bookName}</a></div>
		...
		<div class="rankBook-right">
			<div class="layui-tab layui-tab-card">
			  <ul class="layui-tab-title">
				<li class="layui-this"><span class="layui-badge">hot</span>&nbsp;&nbsp;热门榜</li>
				<li><span class="layui-badge layui-bg-blue">new</span>&nbsp;&nbsp;新上架</li>
			  </ul>
			  <div class="layui-tab-content">
				<div class="layui-tab-item layui-show">
					<!-- 热门榜的内容 -->
				<table class="layui-table" lay-skin="nob" style="width:100%">
					<c:forEach	var="hotbook" items="${hotBookList}" varStatus="status">
						<tr>
							<td style="width:10%">${status.count}</td>
							<td style="width:40%"><a href="${pageContext.request.contextPath}/FindBookDetailServlet?bid=${book.bid}" target="_blank">${hotbook.bookName}</a></td>
							<td style="width:50%">${hotbook.author}</td>
						</tr>
					</c:forEach>
				</table>
				</div>
				<div class="layui-tab-item">
					<!-- 新上架的内容 -->
					<table class="layui-table" lay-skin="nob" style="width:100%">
					<c:forEach	var="newbook" items="${newBookList}" varStatus="status">
						<tr>
							<td style="width:10%">${status.count}</td>
							<td style="width:40%"><a href="${pageContext.request.contextPath}/FindBookDetailServlet?bid=${book.bid}" target="_blank">${newbook.bookName}</a></td>
							<td style="width:50%">${newbook.author}</td>
						</tr>
					</c:forEach>
				</table>
				</div>
