...
<body>
    <!-- 顶部开始 -->
    <div class="container">
        <div class="logo"><a href="">读者中心</a></div>
        <div class="left_open">
		...
		<c:otherwise>
	        <ul class="layui-nav right">
				<li class="layui-nav-item">
	         	...
	         	<li class="layui-nav-item to-index"><a href="../index.jsp">网站首页</a></li>
	        </ul>
         </c:otherwise>
     </c:choose>
     </div>
      ...
      <div id="side-nav">
        <ul id="nav">
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="information.jsp">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>个人信息</cite>
                        </a>
                    </li >
					 <li>
                        <a _href="mybookcase.jsp">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>我的书架</cite>
                        </a>
                    </li >
					 <li>
                        <a _href="returnbooktime.jsp">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>还书日期</cite>
                        </a>
                    </li >
