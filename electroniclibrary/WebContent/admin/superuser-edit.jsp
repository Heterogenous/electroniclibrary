...
<div style="width:420px;margin:0 auto;">
	<form action="${pageContext.request.contextPath}/SuperUserEditServlet?uid=${uid}" method="post">
	...
	<c:if test="${Users.uid==uid}">
	    ...
	    <tr>
	      <td>邮箱:</td>
	      <td colspan="2"><input type="text" id="mail" name="mail" value="${Users.mail}" /></td>
	    </tr>
...
//取消操作
function cancelEdit(){
	window.location="admin-superuser.jsp";
}
//修改操作
function checkForm(){
	var bpassword=checkPassword();
	var bmail=checkMail();
	return bpassword && bmail;
}
//检查密码格式
